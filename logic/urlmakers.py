# Module containing functions to create API request urls.
...
def urlmaker_category(category_id: str) -> str:
    """ Takes category id and returns a url to access the categories API """
...
def urlmaker_currency(currency_id: str) -> str:
    """ Takes currency id and returns a url to access the currencies API """
...
def urlmaker_user(seller_id: str) -> str:
    """ Takes seller id and returns a url to access the users API """
